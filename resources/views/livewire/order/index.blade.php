...
<div class="space-y-8">
  ...
  <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
    <div>
      ...
      <p class="text-sm text-slate-500 dark:text-slate-400 mt-1">Kelola transaksi pesanan pelanggan, validasi pembayaran, cetak invoice PDF, dan notifikasi status pengiriman.</p>
    </div>
    <div>
      <x-link.button
