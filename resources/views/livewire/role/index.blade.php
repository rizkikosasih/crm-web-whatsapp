...
<div class="space-y-8">
  ...
  <div>
    ...
    <p class="text-sm text-slate-400 mt-1">Konfigurasi group hak akses (roles) seperti Administrator, Warehouse, Staff Kasir, dll.</p>
  </div>

  <!-- Form Card -->
  <div id="create-or-update-form" class="w-full">
    <x-card title="{{ $isEdit ? 'Ubah' : 'Tambah' }} Role">
      <x-slot:tools>
