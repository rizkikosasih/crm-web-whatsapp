    ...
    <div class="space-y-5">
      ...
      <div
        ...
        <div class="flex flex-col items-center gap-3 text-emerald-600 dark:text-emerald-400 py-6">
          ...
          <span class="text-lg font-bold text-slate-900 dark:text-white">WhatsApp Terhubung!</span>
      ...
      <div class="flex justify-end pt-4 border-t border-slate-200 dark:border-slate-700/50 gap-3">
        ...
        <x-button type="button" color="default" size="xs" wire:click="getQrCode" class="font-bold">
